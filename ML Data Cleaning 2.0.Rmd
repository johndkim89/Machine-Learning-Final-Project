...
```{r}
new_pp <- dplyr::select (new_pp, HHINC, HTOTVAL, A_SEX, A_AGE, PRCITSHP, PRDTRACE, PENATVTY, PEFNTVTY, PEMNTVTY, PEPAR1TYP, PEPAR2TYP, H_TENURE, A_MARITL, P_STAT, PEAFEVER, PEHSPNON, PEINUSYR, PRDASIAN, PRDTHSP, A_MJIND, A_MJOCC, A_HRS1, A_GRSWK, PEDISDRS, PEDISEAR, PEDISOUT, PEDISPHY, PEDISREM )
```
